package com.asdeire.oop.practice5;
...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        for (Collection<Integer> collection : collections) {
            ...
            for (int dataSize : dataSizes) {
                System.out.println("\nData Size: " + dataSize);
                testCollection(collection, dataSize);
            }
        }
    ...
    public static void testCollection(Collection<Integer> collection, int dataSize) {
        // Заповнення колекції
    ...
    public static int productOfMainDiagonal(int[][] matrix) {
        // Перевіряє чи матриця квадратна
